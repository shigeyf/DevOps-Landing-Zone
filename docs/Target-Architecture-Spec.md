...
> **Status:** Draft v0.5 — ACA Environment refactoring and VNet architecture (platform LZ vs. project BYO vs. application workload) formalized as the target design
>
